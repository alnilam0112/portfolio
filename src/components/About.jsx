...
<br></br><br></br>
Aujourd'hui, je m'oriente vers le développement web full stack. Curieuse, créative et à l'écoute, j'apprécie autant les aspects techniques que la dimension humaine du métier.
<br></br><br></br>
<br></br>
</p>
<h2>Mon projet professionnel</h2>
<p>Afin de poursuivre ma montée en compétences, j'ai choisi d'intégrer la Wild Code School en formation Concepteur Développeur d'Applications.<br></br> 
<strong>Je suis actuellement à la recherche d'une alternance</strong> qui me permettra de mettre un pied dans le monde de l'entreprise, d'apprendre au sein d'un environnement collaboratif et de contribuer à des projets concrets tout en continuant à progresser en tant que développeuse web full stack.
